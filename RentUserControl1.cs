...
{
    public partial class RentUserControl1 : UserControl
    {
        private static RentUserControl1 _instance;
        public static RentUserControl1 Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new RentUserControl1();
                }
                return _instance;
            }
        }
        ...
        public void refresh_DataGridView()
        {
            try
            {
                SqlCommand cmd = new SqlCommand("RentShowSP", con);
        ...
        private void Add_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@DateOut", textBox3.Text);
            cmd.Parameters.AddWithValue("@DateIN", textBox4.Text);
        ...
        private void RentUserControl1_Load(object sender, EventArgs e)
        {
            refresh_DataGridView();
        }
        ...
        private void Delete_Click(object sender, EventArgs e)
        {
            try
            {
                SqlCommand cmd = new SqlCommand("DeleteRentSP", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@UniqueID", textBox1.Text);
                con.Open();
                try
