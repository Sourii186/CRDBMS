...
{
    public partial class RTOCUserControl : UserControl
    {
        private static RTOCUserControl _instance;
        public static RTOCUserControl Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new RTOCUserControl();
                }
                return _instance;
            }
        }
        ...
        public RTOCUserControl()
        {
            InitializeComponent();
        }

        private void RTOCUserControl_Load(object sender, EventArgs e)
        {
